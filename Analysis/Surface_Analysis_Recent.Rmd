...
We create long-form data to facilitate faceted graphics. We need to regenerate 
the long-form data, retaining temperature as a predictor variable, not breaking 
it into a separate data frame.
